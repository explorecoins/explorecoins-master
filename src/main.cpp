...
unsigned int nStakeMinAge = 24 * 60 * 60; // 2 hours
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight == 0){
        ...
        nSubsidy = 100000000 * COIN; // 1 billion coins for ico
    }
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "ExploreCoin";
        CTransaction txNew;
        txNew.nTime = 1506696831;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
/*         if (false  && (block.GetHash() != hashGenesisBlock)) {
   ...
   /*      while (block.GetHash()> hashGenesisBlock)
      ...
      //  hashGenesisBlock = block.GetHash();
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xabd1fde1d2cf6bf48ea7f8f39652c1e415c49722ab559362e8420abc19cad6e7"));
        block.print();
